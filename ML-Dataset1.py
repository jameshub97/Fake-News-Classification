...
# Loading data
fake = pd.read_csv('fnn_testfake.csv', delimiter=',', encoding='unicode_escape', low_memory=False)
true = pd.read_csv('fnn_testreal.csv', delimiter=',', encoding='unicode_escape', low_memory=False)
