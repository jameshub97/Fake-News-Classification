...
# ax = plt.subplot()
# sns.heatmap(cm1boost, annot=True, ax=ax, fmt='g');  # annot=True to annotate cells
# # labels, title and ticks
# ax.set_xlabel('Predicted labels');
# ax.set_ylabel('True labels');
# ax.set_title("Logistic Regression-Boosted");
# ax.xaxis.set_ticklabels(['Fake News', 'Real News']);
# ax.yaxis.set_ticklabels(['Fake news', 'Real News']);
# plt.show()
...
# cm2boosted = confusion_matrix(y_test, y_predDTboosted)
# cm2agger = confusion_matrix(y_test, y_predDTbagged)
#
#
# print("DT","\n")
# print(classification_report(y_test, y_predD, ))
# print("DT boosted","\n")
# print(classification_report(y_test, y_predDTboosted, ))
# print("DT bagged","\n")
# print(classification_report(y_test, y_predDTbagged, ))
...
# ax.set_xlabel('Predicted labels');
# ax.set_ylabel('True labels');
# ax.set_title("Decision Tree-Boosted");
# ax.xaxis.set_ticklabels(['Fake News', 'Real News']);
# ax.yaxis.set_ticklabels(['Fake news', 'Real News']);
# plt.show()

# sns.heatmap(cm2boosted, annot=True, ax=ax, fmt='g');  # annot=True to annotate cells
# # labels, title and ticks
# ax.set_xlabel('Predicted labels');
# ax.set_ylabel('True labels');
...
# cm3boosted = confusion_matrix(y_test, y_predRboosted)
# cmbagger= confusion_matrix(y_test, y_predbagger)
#
#
#
...
# print("RF boosted","\n")
# print(classification_report(y_test, y_predRboosted, ))
# print("RF bagged","\n")
# print(classification_report(y_test, y_predbagger, ))
...
# plt.show()
#
# sns.heatmap(cm3boosted, annot=True, ax=ax, fmt='g');  # annot=True to annotate cells
# # labels, title and ticks
# ax.set_xlabel('Predicted labels');
# ax.set_ylabel('True labels');
# ax.set_title("Random Forest-Boosted");
# ax.xaxis.set_ticklabels(['Fake News', 'Real News']);
# ax.yaxis.set_ticklabels(['Fake news', 'Real News']);
# plt.show()
...
# sns.heatmap(cm4boosted, annot=True, ax=ax, fmt='g');  # annot=True to annotate cells
# # labels, title and ticks
# ax.set_xlabel('Predicted labels');
# ax.set_ylabel('True labels');
# ax.set_title("KNeighbors-Boosted");
# ax.xaxis.set_ticklabels(['Fake News', 'Real News']);
# ax.yaxis.set_ticklabels(['Fake news', 'Real News']);
# plt.show()
